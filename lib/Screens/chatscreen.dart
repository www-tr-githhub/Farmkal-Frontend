                ...
                children: [
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount:
                          _chatController.chatingdata.value.chatData!.length,
                      itemBuilder: (context, index) {
                        ...
                        return MessageBubble(
                          text: _chatController
                              .chatingdata.value.chatData![index].message!,
                          isMe: _chatController
                              .chatingdata.value.chatData![index].type!,
